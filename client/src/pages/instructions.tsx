      ...
      <main className="p-4 space-y-4">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            ...
            <p>В разделе «Личный кабинет и пароль» можно заменить временный пароль на собственный.</p>
        ...
        {canAdminister && (
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>Блок «Тестовый вход под пользователем» позволяет проверить интерфейс с правами выбранного сотрудника. Возврат в кабинет администратора выполняется через боковое меню.</p>
